...
class CategoryRepository(private val flintDao: FlintDao) {
    ...
    suspend fun getCategoryByIdOnce(categoryId: String): CategoryDetails = flintDao.getCategoryItemById(categoryId)
        .map { categoryItem -> categoryItem.toCategoryDetails() }.first()
